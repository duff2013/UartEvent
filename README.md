...
<h4>Disclaimer!!!</h4>
>This is only a beta release and will only work without my updated core on github, there is a bug in the teensy core DMA Channel library with the DMA destination buffers functions. Once that is fixed I'll remove this disclaimer.<br><br>
